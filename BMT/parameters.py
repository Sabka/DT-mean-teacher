...
def get_parameters():
    ...
    parser.add_argument('--datadir', type=str, default='data-local/bin',
                        help='data dir')
    ...
    parser.add_argument('-b', '--batch-size', default=256, type=int, # was 256
                        metavar='N', help='mini-batch size (default: 256)')
    parser.add_argument('--labeled-batch-size', default=62, type=int,# was 62
